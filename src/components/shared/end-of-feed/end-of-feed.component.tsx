...
interface IEndOfFeedProperties {
  page: 'feed' | 'drafts'
}

export default function EndOfFeed(props: IEndOfFeedProperties) {
  const { page } = props
    ...
    <section className="container py-4">
      <div className="p-8 bg-light-bg rounded-xl text-center">
        ...
        <p className="mt-1 text-base text-gray">
          ...
          {page === 'drafts' && 'Do some more activity on-chain and come back later for posting'}
        </p>
        {page === 'feed' && (
