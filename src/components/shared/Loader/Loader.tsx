...
export const Loader = ({show}:any) =>{
    ...
    return (
      <div
        className={`bg-black ${show ? "fixed inset-0 z-50 bg-opacity-50" : ""}`}
      >
        <div
        ...
        >
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            overflow-hidden shadow-xl transform transition-all h-screen opacity-90 sm:align-middle sm:w-full">
              <div style={{transform:"translate(-50%,-50%)"}} className="absolute top-1/2 left-1/2 bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 text-center">
